...
const migration_v23: IMigration = {
  ...
  down: (db) => {
    ...
    console.log('[Migration v23] Rolled back: Removed turn snapshot tables');
  },
};

/**
 * Migration v23 -> v24: Reconcile the split v23 lineage between main and the
 * retained-feature branch. Some local databases may already be at version 23
 * with turn snapshot tables, while others may be at version 23 with only the
 * teams.session_mode column. Ensure both schema additions exist before moving on.
 */
